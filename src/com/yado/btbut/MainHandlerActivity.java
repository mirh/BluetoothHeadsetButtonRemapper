		...
		if (remap) {
			if (todo.equals("CallHandle")) {
				...
				for (int ii = 0; ii < 3; ii++) {
					 ...
					 * -on- android
					 * http://stackoverflow.com/questions/10687535/how-can-i-
					 * change-the-brightness-of-the-screen-in-broadcastreceiver
					 * WindowManager.LayoutParams params =
					 * getWindow().getAttributes(); params.screenBrightness = 0;
